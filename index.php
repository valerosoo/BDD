...
<div id="dest-pop-1">
    <?php
    // Consulta para obtener los 4 destinos más populares
    $sql = "SELECT destino, descripcion, imagen FROM Destinos_Populares ORDER BY total_busquedas DESC LIMIT 4";
    $result = $conexion->query($sql);
    ...
    if ($result && $result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) { ?>
            <div class="card" style="width: 18rem; display: inline-block; margin: 10px;">
                <img src="<?php echo $row['imagen']; ?>" class="card-img-top" alt="<?php echo $row['destino']; ?>">
                <div class="card-body">
